insert into users (downloaded, email, lastlogin, password, points, registred, title, uploaded, username, id) values (5236121, 'paalgyula@paalgyula.com', NULL, '', 512, NULL, 'Administrator', 123512135, 'goofyx', 0);
